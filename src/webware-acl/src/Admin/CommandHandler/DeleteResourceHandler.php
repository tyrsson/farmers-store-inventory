...
final class DeleteResourceHandler implements CommandHandlerInterface
{
    ...
    {
        assert($command instanceof DeleteResourceCommand);

        $this->aclRepository->deleteResource($command->resourcePk);
